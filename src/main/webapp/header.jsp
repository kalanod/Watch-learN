        ...
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <div class="dropdown text-end" id="userBtn">
                ...
                <ul class="dropdown-menu text-small">
                    ...
                    <li><a class="dropdown-item" href="${pageContext.request.contextPath}/tasks?type=onLearn">На
                        изучении ${sessionScope.User.tasksOnWay}</a></li>
                    <li><a class="dropdown-item"
                           href="${pageContext.request.contextPath}$/tasks?type=comleted">Изучено ${sessionScope.User.tasksCompleted}</a>
                    </li>

                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    <li><a class="dropdown-item" href="${pageContext.request.contextPath}/signOut" id="signOutBtn">Sign
                        out</a></li>
                </ul>
            </div>
            <%} else {%>
        ...
        <div class="modal-content rounded-4 shadow">
            ...
            <div class="modal-body p-5 pt-0">
                <form class="">
                    ...
                    <button id="signUpFormBtn" class="w-100 mb-2 btn btn-lg rounded-3 btn-primary" type="button">Sign
                        up
                    </button>
        ...
        <div class="modal-content rounded-4 shadow">
            ...
            <div class="modal-body p-5 pt-0">
                <form class="">
                    ...
                    <button id="signInFormBtn" class="w-100 mb-2 btn btn-lg rounded-3 btn-primary" type="button">Sign
                        in
                    </button>
                </form>
            </div>
